...
public class Stress_DBHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "stressday.db";
    public final String COLUMN_DAY = "day";
    public final String COLUMN_DATE = "date";
    public final String TABLE_NAME = "stress_days";

    public Stress_DBHelper(@Nullable Context context) {
