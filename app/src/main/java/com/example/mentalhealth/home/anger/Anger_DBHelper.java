...
public class Anger_DBHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "angerday.db";
    public final String COLUMN_DAY = "day";
    public final String COLUMN_DATE = "date";
    public final String TABLE_NAME = "anger_days";

    public Anger_DBHelper(@Nullable Context context) {
