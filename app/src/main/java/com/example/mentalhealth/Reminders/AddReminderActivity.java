package com.example.mentalhealth.Reminders;
...
import com.example.mentalhealth.Reminders.data.AlarmReminderContract;
import com.example.mentalhealth.Reminders.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setNegativeButton("Kepp Editting", new DialogInterface.OnClickListener() {
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            if (rowsDeleted == 0) {
                ...
                Toast.makeText(this, "Successfully deleted the reminder",
                        Toast.LENGTH_SHORT).show();
            }
        }
