package com.example.mentalhealth.well_bieng_guide.Anxiety.SQLite;
...
public class Anxiety_DBHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "anxietyday.db";
    public final String COLUMN_DAY = "day";
    public final String TABLE_NAME = "anxiet_days";

    public Anxiety_DBHelper(@Nullable Context context) {
